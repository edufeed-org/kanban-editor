	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					"bg-background shadow-xs hover:bg-accent hover:text-accent-foreground focus-visible:border-accent focus-visible:ring-accent/50 dark:bg-input/30 dark:border-input dark:hover:bg-input/50 border",
