...
// UI-Typen exportieren für Kompatibilität mit Komponenten
...
// ============================================================================
// BOARD STORE (REGULÄRE KLASSE FÜR TS)
// ============================================================================

export class BoardStore {
    // Die Board-Instanz als privater Zustand
    private board: Board;
    ...
    // Öffentliche getter-Funktion, um die Board-Daten abzurufen
    public get data() {
        return this.board;
    }
    ...
    // Konvertiert Board-Daten zu UI-kompatiblem Format
