...
<section 
	...
	use:dndzone={{items:columns, flipDurationMs, type:'column', dragDisabled: false, dropTargetStyle: {outline: '1px solid var(--accent)', 'outline-offset': '-2px'}, touchDelay: 300}} 
