# Changelog Archiv (Legacy)

Hinweis: Diese Datei enthaelt die vollstaendige, historische und ungekonsolidierte Changelog-Fassung aus CHANGELOG.md.

Lesbare Uebersichten:
- docs/CHANGELOG/2026-Q1.md
- docs/CHANGELOG/2025-Q4.md
- docs/CHANGELOG/2024-Q4.md
- docs/CHANGELOG/README.md

Migration:
- Quelle: CHANGELOG.md
- Archiviert am: 2026-02-20
- Grund: Root-Changelog auf kompakte Stakeholder-Ansicht umgestellt
