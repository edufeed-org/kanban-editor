...
|---------|-------|-------------|
| 3.23 | 01.02.2026 | ⚡ **ShareDialog Fixes:** config.json Cache, keine doppelte Share-Link Generierung, parallele Display-Name Loads, BASE_URL Default für GitHub Pages. |
